...
conn = mysql.connector.connect(host="localhost", user="root", passwd="root", db="project", port=3308, use_unicode=True, charset='utf8mb4')


def neutral1(tweet, q):
    Sentiment = "Neutral"
    mycursor = conn.cursor()
    sql = """INSERT INTO data7 (Keyword, Sentiment,Tweet) VALUES(%s,%s,%s)"""
